...
const Profile = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse mb-8 md:items-start items-start">
          ...
          <div className="flex flex-col space-y-4 items-start">
            ...
            <div className="flex items-center space-x-4 mt-8">
              <button
                ...
                className="bg-black text-white font-semibold px-4 py-2 hover:text-black hover:bg-gray-400"
              >
                Update
              </button>
              <button
